...
@section('content')
    ...
    <div class="bg-gray-800 mt-3 mb-6 p-6 rounded">
        <form action="{{ route('manage.game.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8 divide-y divide-gray-600">
            @csrf
            <div class="space-y-8">
                <div>
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input placeholder="Game Title" type="text" name="game_title" class="flex-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full min-w-0 rounded-none rounded-md sm:text-sm border-gray-300">
                            </div>
                            @error('game_title') <small class="text-red-500">{{ $message }}</small> @enderror
                        </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-6">
                                <textarea id="about" name="game_long_description" rows="3" class="shadow-sm block w-full focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md"></textarea>
                            </div>
                ...
                <div>
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div>
                            <input type="checkbox" value="true" name="contain_adult_content" class="mr-1">
